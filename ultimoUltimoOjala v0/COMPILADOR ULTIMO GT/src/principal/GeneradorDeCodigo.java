...
public class GeneradorDeCodigo {
    ...
    public void finalizarMemoria(int cantidadDeVariables, String nombreArchivo)throws FileNotFoundException, IOException {
        int distancia = 1416 - (topeMemoria + 5); // +5 PORQUE ES DESPUES DEL E9
    ...
    public void mostrarMemoria() {
        for (int i = 0; i < topeMemoria; i++) {
            String aux = Integer.toHexString(memoria[i]);
    ...
    public int getTAMANO_HEADER() {
        return TAMANO_HEADER;
    }
